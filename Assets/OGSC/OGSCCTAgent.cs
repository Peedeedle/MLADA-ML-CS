...
public class OGSCCTAgent : Agent
{
    ...
    //
    public Transform CTshootingPoint;
    ...
    //
    public RayPerceptionSensor CTRPS;

    //
    private void Awake() {

        //
        CTRigidBody = this.GetComponent<Rigidbody>();

        //
        TRigidBody = TEnemy.GetComponent<Rigidbody>();

        //
        CTRPS = this.GetComponent<RayPerceptionSensor>();
    ...
    public override void CollectObservations(VectorSensor sensor) {
        ...
        if (this.gameObject.tag == "CT") {
            ...
            //
            sensor.AddObservation(TEnemy.transform.position);

            //
            Vector3 dirToT = (TEnemy.transform.localPosition - transform.localPosition).normalized;
        ...
        //if (this.gameObject.tag == "T") {
            ...
            //
            //sensor.AddObservation(CT.transform.position);

            //
            //Vector3 dirToCT = (CT.transform.localPosition - transform.localPosition).normalized;
    ...
    public override void OnActionReceived(ActionBuffers actions) {
        ...
        //
        //T.transform.localPosition += new Vector3(moveX, 0, moveZ) * Time.deltaTime * moveSpeed;
    ...
    public void Update() {
        ...
        //
        var layerMaskEnemy = 1 << LayerMask.NameToLayer("T");
        ...
        //
        if (Physics.Raycast(CTshootingPoint.position, direction, out var Hit, 20f)) {

            //
            //Debug.Log("HIT Wall");

            Debug.DrawLine(CTshootingPoint.position, Hit.point, Color.red);
        ...
        */
        ...
        if (Hit.transform.gameObject.tag == "T") {
